...
Automated deployment of one Velociraptor server with one Windows 10 endpoint in Azure VM infrastructure.  A collection of Terraform and Ansible scripts that automtically deploys a small Velociraptor R&D lab.
